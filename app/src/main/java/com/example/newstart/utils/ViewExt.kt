...
fun ImageView.loadImage(url: String,@DrawableRes placeholder: Int,@DrawableRes errorId: Int) =
    Glide.with(context).asDrawable().load(url).placeholder(placeholder)
        .error(errorId).into(this)

fun ImageView.loadImage(url: String) =
    Glide.with(context).asDrawable().load(url).placeholder(R.drawable.ic_healthy_food)
        .error(R.drawable.ic_healthy_food).into(this)

//fun ImageView.loadImage(url: String) = Glide.with(context).placeholder(R.drawable.ic_healthy_food).error(R.drawable.ic_healthy_food).into(this)
